...
IF(ns_flag == 1) THEN
	CALL NSRToP(rho2_c, p2_c)
	CALL NSRToP(rho2_a, p2_a)
	CALL NSRToE(rho2_c, rhoe2_c)
	CALL NSRToE(rho2_a, rhoe2_a)
ELSEIF(ns_analytic == 1) THEN
	CALL ANALYTIC_RTOP (p2_c, rho2_c)
	CALL ANALYTIC_RTOP (p2_a, rho2_a)
	rhoe2_c = 0.0D0
	rhoe2_a = 0.0d0
ELSE
